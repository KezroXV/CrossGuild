...
import {
  fetchDevPasswordResetTokens,
  type DevPasswordResetToken,
} from "@/features/auth/services/auth.service";

export default function DevPasswordTokensView() {
  const [tokens, setTokens] = useState<DevPasswordResetToken[]>([]);
  ...
  useEffect(() => {
    const loadTokens = async () => {
      try {
        const data = await fetchDevPasswordResetTokens();
        setTokens(data);
      } catch (err) {
        setError(
