...
export const HeroSection = () => {
  return (
    <section className="relative flex flex-col items-center justify-center text-center text-white py-32">
      ...
      <div className="mt-6 flex justify-center gap-4">
        <Button className="bg-purple-600 px-6 py-3 text-lg">Shop Now</Button>
        <Button variant="outline" className="px-6 text-black py-3 text-lg">
          New Arrivals!
        </Button>
      </div>
    </section>
