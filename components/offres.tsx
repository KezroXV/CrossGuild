  ...
  return (
    <div className="text-left ">
      ...
      <div className="flex w-4/5 mx-auto justify-between my-8">
        <div className="bg-gradient-to-bl from-[#988AE6] to-accent flex justify-evenly text-white p-10 rounded-lg  relative">
          <div>
        ...
        <div className="bg-gradient-to-br from-[#988AE6] to-accent flex justify-evenly text-white p-10 rounded-lg  relative">
          <div>
            <div className="text-sm mb-2">
      ...
      {/* Newsletter */}
      <div className="bg-primary/30 flex justify-between p-12 rounded-lg mt-8 w-4/5 m-auto">
        <div>
